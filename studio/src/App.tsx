...
import { RiAliensFill, RiCloseLine, RiServerLine, RiSettings2Line } from "react-icons/ri"

import { Fragment, useState } from 'react'

const navigation = [
  { name: 'Config', href: '/config', icon: RiSettings2Line, current: true },
  { name: 'Instances', href: '/instances', icon: RiServerLine, current: false },
]
          ...
          <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-gray-100">
            ...
            <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
              <a href="#" className="group block w-full flex-shrink-0">
                <div className="flex items-center">
                  <div>
                    <RiAliensFill size={32} />
                  </div>
                  <div className="ml-3">
                    <p className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Alive</p>
          ...
          <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-4 py-1.5">
            ...
            <div>
              ...
              >
                ...
                <RiAliensFill className="h-6 w-6" aria-hidden="true" />
              </button>
            </div>
          </div>
        </div>
